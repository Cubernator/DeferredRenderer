#ifndef GRAPHICS_SHADER_PROPERTY_HPP
#define GRAPHICS_SHADER_PROPERTY_HPP
...
namespace type_erasure {
	...
	struct concept_interface<hexeract::graphics::uniform_settable<C>, Base, C> : Base
	{
		void applyTo(const hexeract::graphics::ShaderProgram* program, hexeract::graphics::uniform_id id) const
		{
			call(hexeract::graphics::uniform_settable<C>(), program, id, *this);
		}
	};
}
}
...
#endif // GRAPHICS_SHADER_PROPERTY_HPP