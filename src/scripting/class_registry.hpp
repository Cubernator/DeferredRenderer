...
namespace														\
{																\
	hexeract::scripting::detail::class_registerer register_class##className (#className);	\
}

#define SCRIPTING_REGISTER_DERIVED_CLASS(className, baseName)						\
namespace															\
{																	\
	hexeract::scripting::detail::class_registerer register_class##className (#className, #baseName);	\
}
...
namespace																								\
{																										\
	hexeract::scripting::detail::method_registerer register_method_##className##_##methodName(#className, #methodName, (SCRIPTING_CALLBACK_NAME(className, methodName)));\
}																										\
