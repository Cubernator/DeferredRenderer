#ifndef CORE_COMPONENT_REGISTRY_HPP
#define CORE_COMPONENT_REGISTRY_HPP
...
namespace																	\
{																			\
	hexeract::detail::abstract_component_registerer<c> register_component_##c (#c);	\
}

#define REGISTER_COMPONENT_CLASS(c)								\
namespace														\
{																\
	hexeract::detail::component_registerer<c> register_component_##c (#c);\
}

#endif // CORE_COMPONENT_REGISTRY_HPP